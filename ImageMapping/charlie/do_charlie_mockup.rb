...
# -----------------------------------------------------------------
# ASSUMPTION: original image is 300 DPI
...
REPEATED_PNG_IMAGE_PATH = 'charlie/images/temp/2_image_png_repeated.png'

REPEATED_PNG_RESIZED_IMAGE_PATH = 'charlie/images/temp/3_image_png_repeated_resized.png'

REPEATED_PNG_RESIZED_CROPPED_IMAGE_PATH = 'charlie/images/temp/4_image_png_repeated_resized_cropped.png'

MAPPED_IMAGE_PATH = 'charlie/images/output/mapped_image.png'

# -----------------------------------------------------------------
# pillow width / height in inches and pixels
...
puts 'Pillow width in inches: ' + MAPPED_IMAGE_WIDTH_IN_INCHES.to_s
puts 'Pillow height in inches: ' + MAPPED_IMAGE_HEIGHT_IN_INCHES.to_s
...
API_URL = 'https://api.mediamodifier.com/mockup/render'
